...
export const primaryProjects = [
	{
		image: ProtoStore,
		title: "Proto Store",
		techs: ["React.js", "API REST", "Tailwind CSS"],
		status: "En desarrollo",
		description:
			"Proto Store es una tienda en línea interactiva creada durante un curso en Platzi, utilizando React y Tailwind CSS. Incluye funcionalidades de carrito de compras para una experiencia de usuario completa y dinámica. Además, consume una API REST pública y gratuita para cargar productos en tiempo real.",
	...
	},
	{
		image: Logo7,
		title: "Próximamente",
		techs: ["Amor por la tecnología"],
		status: "",
		description:
			"Estoy trabajando en nuevos proyectos que estarán disponibles pronto. ¡Mantente al tanto para ver más de mi trabajo y explorar nuevas ideas y desarrollos!",
...
export const othersProjects = [
	{
		...
		status: "O.K.",
		description:
			"Calculadora básica desarrollada en React como parte de un proyecto en TalentoTech. Permite realizar operaciones matemáticas esenciales de forma rápida e intuitiva, con un diseño limpio y funcional.",
